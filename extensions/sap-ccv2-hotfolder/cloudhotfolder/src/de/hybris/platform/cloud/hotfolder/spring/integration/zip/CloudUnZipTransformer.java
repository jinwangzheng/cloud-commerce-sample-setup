...
public class CloudUnZipTransformer extends AbstractZipTransformer
{
    ...
    {
        final UUID messageId = message.getHeaders().getId();
        Assert.notNull(messageId, "message.headers.id must not be null.");
        return new File(workDirectory, messageId.toString());
    }
