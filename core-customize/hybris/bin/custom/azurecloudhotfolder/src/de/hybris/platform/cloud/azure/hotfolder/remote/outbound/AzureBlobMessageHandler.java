 ...
 */
public class AzureBlobMessageHandler extends FileTransferringMessageHandler<BlobClient>
{
    ...
    public AzureBlobMessageHandler(final SessionFactory<BlobClient> sessionFactory)
    {
    ...
    public AzureBlobMessageHandler(final RemoteFileTemplate<BlobClient> remoteFileTemplate)
    {
        super(remoteFileTemplate);
    }
    ...
    {
        final Object value = message.getHeaders().get(FileHeaders.ORIGINAL_FILE);
