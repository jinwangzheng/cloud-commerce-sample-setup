...
<c:choose>
	...
	<c:otherwise>
		<%-- jquery --%>
		<script src="${commonResourcePathHtml}/js/jquery-3.7.1.min.js"></script>
		...
		<script src="${commonResourcePathHtml}/js/acc.verificationtoken.js"></script>
		<script src="${commonResourcePathHtml}/js/acc.registrationwithverificationtoken.js"></script>
