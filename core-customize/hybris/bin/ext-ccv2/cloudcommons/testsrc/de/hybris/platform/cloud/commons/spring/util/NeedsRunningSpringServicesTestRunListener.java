...
public class NeedsRunningSpringServicesTestRunListener extends CustomRunListener implements BeanFactoryAware, InitializingBean
{
    ...
    /**
     * Returning 10, to prevent overriding of EmbeddedServerTestRunListener or TaskEngineTestRunListener in CustomActionsRunListener.
     * EmbeddedServerTestRunListener and TaskEngineTestRunListener both return priority 0 that is defined in parent class CustomRunListener.
     */
    @Override
